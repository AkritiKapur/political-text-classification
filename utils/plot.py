...
def plot_confusion_matrix(cm, labels):
    ...
    :param labels: Labels to be displayed on the axis
    :return: Matplotlib Plot

    Citation: https://stackoverflow.com/questions/19233771/sklearn-plot-confusion-matrix-with-labels
    """
    fig = plt.figure()
...
def plot_confusion_matrix_blue(cm,
                          target_names,
